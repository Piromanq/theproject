...
<div class="card-word__wrapper">
    <h1>Ваше письмо успешно отравлено администрации сайта!</h1>
    <div class="admin-wrapper-word">
    <span class="admin-word">От Администрации сайта pitstop-klintsy.ru.<br></span>
    </div>
    <div>
        <i class="fa fa-info-circle" aria-hidden="true"></i><br>
        <span>
   Мы получили ваше письмо и обязательно ответим вам!
    </span>
